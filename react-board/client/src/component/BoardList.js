...
function BoardList(){
    ...
    useEffect(() => {
        axios.get('http://192.168.50.83:8000/getBoard').then((response)=>{
    ...
    const viewCount = (e) => {
        if(cookies.id != e.user_id){
        axios.post('http://192.168.50.83:8000/viewCount', {
            idx: e.idx,
        })
        }
    }
    ...
    return (
        ...
        <div className='container'>
            ...
            {state.boardList && state.boardList.map(element => 
                ...
                <hr />
                    ...
                    :
                    <img src={'http://192.168.50.83:8000/static/image/image.jpg'} width='2.5%' style={{margin:'5px'}}></img>
                    }
                    </span> 
